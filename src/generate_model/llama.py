...
class SpicyBoros(LLMModel):
    ...
    def generate(self, data):
        inputs = self.tokenizer(data["message"])
...
class SpicyBorosSmall(SpicyBoros):
    def load_model(self):
        ...
        device_map = infer_auto_device_map(self.model, max_memory={0: "40GiB", 1: "10GiB"})
        self.model = load_checkpoint_and_dispatch(
                self.model, "/home/hz/.cache/huggingface/hub/models--jondurbin--spicyboros-13b-2.2/snapshots/aa54c2a38c71ff189aeb2346e0ec4d04e517d042", device_map=device_map
            )
